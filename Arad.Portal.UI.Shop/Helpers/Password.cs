...
namespace Arad.Portal.UI.Shop.Helpers
{
    public static class Password
    {
            ...
            bool includeSpecial, bool includeSpaces, int lengthOfPassword)
        {
            ...
            const string LOWERCASE_CHARACTERS = "abcdefghijklmnpqrstuvwxyz";
            const string UPPERCASE_CHARACTERS = "ABCDEFGHIJKLMNPQRSTUVWXYZ";
            const string NUMERIC_CHARACTERS = "123456789";
            ...
            bool includeSpecial, bool includeSpaces, string password)
        {
            ...
            return lowerCaseIsValid && upperCaseIsValid && numericIsValid && spacesAreValid;
        }
    }
}
