...
Bootstrap Icon Picker is a fully customizable plugin for Twitter Bootstrap 5,
with a powerful base API, based on [fontawesome-iconpicker
](https://github.com/itsjavi/fontawesome-iconpicker)



[View demos](https://pixel-s-lab.github.io/bootstrapicon-iconpicker/)
