...
public static class DictionaryHelper
{
    ...
    {
        FieldInfo[] fields = typeof(TEnum).GetFields(BindingFlags.Public | BindingFlags.NonPublic | BindingFlags.Static);

        return fields.ToDictionary(t => t.Name, t => t.GetRawConstantValue());
    }
}