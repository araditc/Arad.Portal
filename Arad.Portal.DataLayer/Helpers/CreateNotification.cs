...
namespace Arad.Portal.DataLayer.Helpers
{
    public class CreateNotification
    {
        ...
        public async Task<Result> AddReminderProductNotify(string templateName, Entities.Shop.Product.Product product, string adminId, NotificationType notificationType)
        {
            try
            {
